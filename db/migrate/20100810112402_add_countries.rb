class AddCountries < ActiveRecord::Migration
  ...
  def self.up
    Authorization::Maintenance::without_access_control do
      countries =
      #country array is from: http://github.com/rails/country_select/blob/master/lib/country_select.rb
      ...
      "Korea, Republic of", "Kosovo, Republic of", "Kuwait", "Kyrgyzstan", "Lao People's Democratic Republic",
      ...
      countries.each do |c| Country.new(:name => c).save
    end
  end
